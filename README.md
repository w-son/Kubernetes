# Kubernates
대규모 서비스 지원 환경에서 효율적인 서버 자원 이용을 위해 auto-scaling, auto-healing, auto-deployment 를 지원하는 오픈소스  
...
Docker 와 같은 컨테이너 서비스가 제공되는 환경에서 구동시키면 새로운 Host 환경에 구애받지 않고 서비스를 구축할 수 있다는 장점이 있다  
